...
const VALID_THEMES = ['forest', 'dragons-fire', 'royal-sash', 'bog-of-carbohydrates', 'dungeons-and-dumbells', 'fatburn-forest', 'lake-nightrun', 'mount-protein', 'recovery-tavern', 'grove-of-endurance'];
const VALID_TRACKS = [
    'HammeringHearts.mp3',
    'MistyTaverns.mp3',
    'PipeSmoke.mp3',
